...
4. 部署MTest（用例管理系统-后端）：更改jar包里面applicantContent.xml数据库配置,运行MTest.jar，默认端口8084
5. 部署MTest_front（用例管理系统-前端）：后端默认请求本地端口8084，更改后端域名，修改src/utils/request.js的baseUrl，并重新打包
