    ...
    <div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="query.name" placeholder="功能名" class="handle-input mr10"></el-input>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="页面模块名">
                    <input type="hidden" name="form.pageModulesId" :vaule="form.pageModulesId">
...
<script>
import { fetchFunctionsData } from "../api/index";
import { updateFunctionsData } from "../api/index";
import { deleteFunctionsData } from "../api/index";
export default {
    name: "pageMoudles",
    data() {
        return {
    ...
    methods: {
        getData() {
            fetchFunctionsData(this.query).then(res => {
        ...
        handleDelete(index, row) {
            ...
            this.$confirm("确定要删除吗？", "提示", {
                ...
                .then(() => {
                    let data = { id: row.id };
                    deleteFunctionsData(data).then(res => {
                        if (res.code === 200) {
        ...
        // 保存编辑
        saveEdit() {
            updateFunctionsData(this.form).then(res => {
                if (res.code === 200) {
