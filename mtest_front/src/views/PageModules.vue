    ...
    <div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="query.name" placeholder="页面模块名" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="name" label="页面模块名"></el-table-column>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="100px">
                <el-form-item label="页面模块ID">
                    <el-input v-model="form.id" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="项目系统名">
                    <input type="hidden" name="form.systemsId" :vaule="form.systemsId">
...
<script>
import { fetchPageModulesData } from "../api/index";
import { updatePageModulesData } from "../api/index";
import { deletePageModulesData } from "../api/index";
export default {
    name: "pageMoudles",
    data() {
        return {
    ...
    methods: {
        getData() {
            fetchPageModulesData(this.query).then(res => {
        ...
        handleDelete(index, row) {
            ...
            this.$confirm("确定要删除吗？", "提示", {
                ...
                .then(() => {
                    let data = { id: row.id };
                    deletePageModulesData(data).then(res => {
                        if (res.code === 200) {
        ...
        // 保存编辑
        saveEdit() {
            updatePageModulesData(this.form).then(res => {
                if (res.code === 200) {
